  ...
  return (
    <div className="space-y-6">
      ...
      <div
        ...
        style={{
          background: "hsl(45, 93%, 55%, 0.06)",
          border: "1px solid hsl(45, 93%, 55%, 0.15)",
        }}
      >
        <HelpCircle
          size={16}
          style={{ color: "hsl(45, 93%, 55%)", marginTop: 1, flexShrink: 0 }}
        />
        <div>
          <p
      ...
      <CareerTrajectoryChart mode="forecast" />
        ...
        {forecasts.length === 0 ? (
          ...
          <div className="space-y-3">
            {forecasts.map((forecast, index) => {
              ...
              const dirColor =
                DIRECTION_COLORS[forecast.direction] || "hsl(262, 83%, 58%)";
              const TrendIcon =
              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    onClick={() =>
                      setExpandedForecast(isExpanded ? null : forecast.id)
                    }
                  >
                    <div className="flex items-center gap-3 sm:gap-4">
                      <div
                        ...
                        style={{
                          background: `color-mix(in srgb, ${dirColor} 7.06%, transparent)`,
                        }}
                      >
                            ...
                            {forecast.behavioralEvidence &&
                              forecast.behavioralEvidence.length > 0 && (
                                ...
                                >
                                  ...
                                  <ul className="space-y-1">
                                    {forecast.behavioralEvidence.map(
                                      (s: string, i: number) => (
                                        <li
                                          key={i}
                                          className="text-xs"
                            ...
                            {forecast.experimentResults &&
                              forecast.experimentResults.length > 0 && (
                                ...
                                >
                                  ...
                                  <ul className="space-y-1">
                                    {forecast.experimentResults.map(
                                      (s: string, i: number) => (
                                        <li
                                          key={i}
